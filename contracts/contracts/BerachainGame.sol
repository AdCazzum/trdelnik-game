...
contract BerachainGame is Ownable, ReentrancyGuard {
    /* ────────────────────────  Types  ───────────────────────── */
    ...
    function _requestStep(uint256 gameId) internal {
        ...
        uint256 randomBp = uint256(keccak256(abi.encodePacked(block.prevrandao, block.timestamp, gameId, nextStep))) % 10_000;
